document.addEventListener('DOMContentLoaded', function() {
    ...
    basketImage.src = 'PENGUIN.png'; // Adjust the path as needed
    ...
    function initChips(num) {
        ...
        for (let i = 0; i < num; i++) {
            ...
            let image = 'CHIP 1 (left).png'; // Adjust path as needed
    ...
    movingImage.src = 'PENGUIN 3.png'; // Adjust the path as needed
